...
/**
 * Tailwind CSS adapter stub.
 * Full implementation deferred to future sprint when Tailwind integration is required.
 */
export class TailwindAdapter implements UIAdapter {
  readonly type: AdapterType = 'tailwind';
  readonly version = '0.0.0';
  readonly isAvailable = false;

  private _config: AdapterConfig = { type: 'tailwind', version: '0.0.0' };
